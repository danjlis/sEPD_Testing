...
int ReadDarkCurrent(int n, char* name, double x = 0, double y = 0){
...
int DrawALine(char* filename, int n_rep = 5, double ds = 0.5 ,double xi =4.5 , double yi = 24, double xf = 88, double yf = 46, int DCViasVoltage = 67){
...
int take_action(int list[], char *action, char *x1, char *y1, char *x2, char *y2, char *n, char *dx, char *dy, char *nx, char *ny, char *channel1, char *channel2, char *channel3, char *channel4, char *name = "OUTPUT"){
	...
	else if (act == 1) cheese = ReadDarkCurrent(n_rep, filename, xorigincm, yorigincm);
	else if (act == 2) cheese = DrawALine(filename, n_rep);
	else if (act == 3) cheese = FullSectorScan(filename, n_rep);
