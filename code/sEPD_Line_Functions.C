...
std::string ParseFileName(std::string in_file, int all_runs, ch_1, ch_2, bool debug = false){
...
void GetFileName(std::vector<std::string> *filenames, int sector, int all_runs, int ch1, int ch2, bool debug = false){
  ...
  while ((entry = readdir(dp))){
    ...
    date = ParseFile(in_file, all_runs, ch1, ch2);
...
std::string MakeRootFile(std::string inputFileName, const std::string datadir, const std::string savedir, int ttt = 32, bool debug = false){
